...
class SketchCodeModel():
    ...
    def __init__(self, model_output_path, model_json_file=None, model_weights_file=None):
        ...
        if model_json_file is not None and model_weights_file is not None:
            ...
            optimizer = Adam(lr=0.000005, clipvalue=1.0)
    ...
    def create_model(self):
        ...
        image_model.add(Conv2D(16, (5,5), padding='valid', activation='relu', input_shape=(256, 256, 3,)))
        image_model.add(Conv2D(16, (5,5), activation='relu', padding='same', strides=2))
