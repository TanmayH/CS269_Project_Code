...
class Compiler:
    ...
    def compile(self, generated_gui):
        ...
        #Parse fix
        # print ("DSL file before : ",dsl_file)
        ...
        for token in dsl_file:
            ...
            if token.find(self.opening_tag) != -1:
                ...
                # print("Element: ",element.key, element.parent.key, element.content_holder)
        ...
        output_html,_ = self.root.render(self.dsl_mapping,spacing=8, script_holder="changes={}\n")
