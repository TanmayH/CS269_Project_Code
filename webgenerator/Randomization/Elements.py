...
class ElementsChoices:
	...
	n_items_section_limits = [1, 2]  #[1,3]
	n_section_limits = [1, 2] #[1,3]
	n_items_descriptor_limits = [1, 2] #[1,3]

	page_type_choices = [PageTypes.Content, PageTypes.Form]
	page_type_choices_p = [0.5, 0.5]

	#Mixer
	mixable_elements = [Mixable.Paragraph, Mixable.List] #Removing mix-feature, mix-heading from mixed  
	mixable_elements_max_two_columns = [Mixable.Table] #Removing mix-collapse
	...
	composed_elements = [Composed.Carousel, Composed.Tabs, Composed.FeaturedItems, Composed.Cards, Composed.MixOfMixable]
	composed_elements_p = [0.2,0,0.4,0,0.4]
	...
	#Form
	n_form_rows_limits = [1,3]
	n_form_columns_choices = [1,2]  #[1,2,3,4]
	n_form_columns_choices_p = [0.5,0.5] #[0.4,0.3,0.2,0.1]
	...
	input_types_p = [0.2, 0.4, 0, 0, 0.4, 0,0]
